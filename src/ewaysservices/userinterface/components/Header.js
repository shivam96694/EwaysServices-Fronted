...
const Header = () => {
  ...
  const renderAuthButtons = () =>
   ...
   <>   <Box sx={{display:'flex',justifyContent:'center',alignItems:'center', mt: 2,mb:2 }}>
      ...
      <div style={{display:'flex',justifyContent:'center',alignItems:'center', mt: 2,fontWeight: "bold",gap: "12px",fontSize: 17,fontFamily: "sans-serif",}}>
      ...
      <Toolbar sx={{ justifyContent: "space-between", minHeight: 70 }}>
        ...
        {!matches && (
          ...
          >
            ...
            >
              <Box
                sx={{ ...navLinkStyle, display: "flex", alignItems: "center" }}
              >
              ...
              >
                <MenuItem onClick={() => { handleServicesClose(); document.getElementById("services-section")?.scrollIntoView({ behavior: 'smooth', }); }}>Web Development</MenuItem>
                <MenuItem onClick={() => { handleServicesClose(); document.getElementById("services-section")?.scrollIntoView({ behavior: 'smooth', }); }}>App Development</MenuItem>
                <MenuItem onClick={() => { handleServicesClose(); document.getElementById("services-section")?.scrollIntoView({ behavior: 'smooth', }); }}>
                  SEO Optimization
                </MenuItem>
                <MenuItem onClick={() => { handleServicesClose(); document.getElementById("services-section")?.scrollIntoView({ behavior: 'smooth', }); }}>Other Services</MenuItem>
              </Menu>
            </Box>
